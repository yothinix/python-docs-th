Translation of the Python Documentation — th
============================================

.. image:: https://travis-ci.org/python/python-docs-th.svg?branch=3.7
  :target: https://travis-ci.org/python/python-docs-th
...
- Or just by opening `an issue on github <https://github.com/python/python-docs-thfr/issues>`_
...
You'll need to fork the `python-docs-th
<https://github.com/python/python-docs-th>`_ clicking its ``Fork``
...
.. code-block:: bash
    ...
    git clone git@github.com:JulienPalard/python-docs-th.git

    # Go to the cloned directory:
    cd python-docs-th/

    # Add the upstream (the public repository) using HTTPS (won't ask for password):
    git remote add upstream https://github.com/python/python-docs-th.git
...
.. code-block:: bash
    ...
    # https://github.com/python/python-docs-th/ and a nice "Compare & pull request"
...
All those snippets are to run from the root of a ``python-docs-th``
